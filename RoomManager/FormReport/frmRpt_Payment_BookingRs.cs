    ...
    public partial class frmRpt_Payment_BookingRs : XtraReport
    {
        ...
        public frmRpt_Payment_BookingRs(NewPaymentEN aNewPaymentEN)
        {
            ...
            try
            {
                ...
                if (aNewPaymentEN.CustomerType == 3)
                {
                ...
                { 
                    //string CustomerName;
                    //foreach(BookingRoomUsedEN aBookingRoomTemp in this.aNewPaymentEN.aListBookingRoomUsed)
                    //{
                    //    foreach (Customers aCus in aBookingRoomTemp.ListCustomer)
                    //    {
                    //        CustomerName = aCus.Name + "" + CustomerName;
                    //    }
                    //}
                    //lblNameCustomer.Text = CustomerName;
                }
                ...
                colDateInUse.DataBindings.Add("Text", this.DetailReport.DataSource, "MoneyRoom", "{0:0,0}");
