...
namespace RoomManager
{
    public partial class uc_Tooltip_StatusRoom_3 : UserControl
    {
        ...
        {
            frmTsk_EditBooking afrm = new frmTsk_EditBooking(this.Datasource.BookingRooms_ID, this.afrmMain);
            afrm.ShowDialog();
            this.Parent.Dispose();
        }
        ...
        private void btnCheckInHalls_Click(object sender, EventArgs e)
        {
            try
            {
                if(this.Datasource.BookingRs_CustomerType == 1)
                {
                    frmTsk_BookingHall_Customer_New afrmTsk_BookingHall_Customer = new frmTsk_BookingHall_Customer_New(this.Datasource.BookingRs_ID, this.Datasource.Companies_ID, this.Datasource.Customers_ID,1);
                    afrmTsk_BookingHall_Customer.ShowDialog();
                    this.Parent.Dispose();
                }
                else if (this.Datasource.BookingRs_CustomerType == 2)
                {
                    frmTsk_BookingHall_Customer_New afrmTsk_BookingHall_Customer = new frmTsk_BookingHall_Customer_New(this.Datasource.BookingRs_ID, this.Datasource.Companies_ID, this.Datasource.Customers_ID,2);
                    afrmTsk_BookingHall_Customer.ShowDialog();
                    this.Parent.Dispose();
                }
                else if (this.Datasource.BookingRs_CustomerType == 3)
                {
                    frmTsk_BookingHall_Customer_New afrmTsk_BookingHall_Customer = new frmTsk_BookingHall_Customer_New(this.Datasource.BookingRs_ID, this.Datasource.Companies_ID, this.Datasource.Customers_ID,3);
                    afrmTsk_BookingHall_Customer.ShowDialog();
                    this.Parent.Dispose();
                }
            }
