...
namespace DataAccess
{
    ...
    public partial class DatabaseDA : DbContext
    {
        ...
        public virtual DbSet<CustomerGroups_Customers> CustomerGroups_Customers { get; set; }
        ...
        public virtual DbSet<Permits_SystemUsers1> Permits_SystemUsers1 { get; set; }
        public virtual DbSet<SystemUserExts> SystemUserExts { get; set; }
        public virtual DbSet<BookingHalls> BookingHalls { get; set; }
        public virtual DbSet<BookingHalls_Services> BookingHalls_Services { get; set; }
        public virtual DbSet<BookingHs> BookingHs { get; set; }
        public virtual DbSet<Foods> Foods { get; set; }
        public virtual DbSet<Guests> Guests { get; set; }
        public virtual DbSet<Halls> Halls { get; set; }
        public virtual DbSet<Menus> Menus { get; set; }
        public virtual DbSet<Menus_Foods> Menus_Foods { get; set; }
        public virtual DbSet<Allowances> Allowances { get; set; }
        public virtual DbSet<AlternateMissions> AlternateMissions { get; set; }
        public virtual DbSet<AuditHistories> AuditHistories { get; set; }
        public virtual DbSet<CalculatorSalaries> CalculatorSalaries { get; set; }
        public virtual DbSet<Certificates> Certificates { get; set; }
        public virtual DbSet<Contracts> Contracts { get; set; }
        public virtual DbSet<Contracts_Allowances> Contracts_Allowances { get; set; }
        public virtual DbSet<Designations> Designations { get; set; }
        public virtual DbSet<Divisions> Divisions { get; set; }
        public virtual DbSet<DocumentSystemUsers> DocumentSystemUsers { get; set; }
        public virtual DbSet<FamilyMembers> FamilyMembers { get; set; }
        public virtual DbSet<GroupTableSalaries> GroupTableSalaries { get; set; }
        public virtual DbSet<RewardAndPunishments> RewardAndPunishments { get; set; }
        public virtual DbSet<SystemUserExts1> SystemUserExts1 { get; set; }
        public virtual DbSet<SystemUsers_Certificates> SystemUsers_Certificates { get; set; }
        public virtual DbSet<SystemUsers_Divisions> SystemUsers_Divisions { get; set; }
        public virtual DbSet<TableSalaries> TableSalaries { get; set; }
        public virtual DbSet<BookingRoomByType> BookingRoomByType { get; set; }
        public virtual DbSet<BookingRooms> BookingRooms { get; set; }
        public virtual DbSet<BookingRooms_Services> BookingRooms_Services { get; set; }
        public virtual DbSet<BookingRoomsMembers> BookingRoomsMembers { get; set; }
        public virtual DbSet<BookingRs> BookingRs { get; set; }
        public virtual DbSet<BookingRs_BookingHs> BookingRs_BookingHs { get; set; }
        public virtual DbSet<CheckPoints> CheckPoints { get; set; }
        public virtual DbSet<ExtraCosts> ExtraCosts { get; set; }
        public virtual DbSet<Payment> Payment { get; set; }
        public virtual DbSet<Rooms> Rooms { get; set; }
        public virtual DbSet<vw__BookingHalls_ServicesInfo__BookingHalls_BookingHallsServices_Services_ServiceGroups> vw__BookingHalls_ServicesInfo__BookingHalls_BookingHallsServices_Services_ServiceGroups { get; set; }
        public virtual DbSet<vw__BookingHInfo__BookingHs_Customers_Companies_SystemUsers> vw__BookingHInfo__BookingHs_Customers_Companies_SystemUsers { get; set; }
        public virtual DbSet<vw__BookingRInfo__BookingRooms_Room_Customers_CustomerGroups> vw__BookingRInfo__BookingRooms_Room_Customers_CustomerGroups { get; set; }
        public virtual DbSet<vw__BookingRInfo__BookingRooms_Rooms_SystemUsers_Customers_CustomerGroups> vw__BookingRInfo__BookingRooms_Rooms_SystemUsers_Customers_CustomerGroups { get; set; }
        public virtual DbSet<vw__BookingRInfo__BookingRs_Customers_Companies_SystemUsers> vw__BookingRInfo__BookingRs_Customers_Companies_SystemUsers { get; set; }
        public virtual DbSet<vw__BookingRoomInfo__BookingRs_BookingRooms_Rooms> vw__BookingRoomInfo__BookingRs_BookingRooms_Rooms { get; set; }
        public virtual DbSet<vw__BookingRooms_ServicesInfo__BookingRooms_BookingRoomsServices_Services_ServiceGroups> vw__BookingRooms_ServicesInfo__BookingRooms_BookingRoomsServices_Services_ServiceGroups { get; set; }
        public virtual DbSet<vw__CertificatesInfo__SystemUsers_Certificates> vw__CertificatesInfo__SystemUsers_Certificates { get; set; }
        public virtual DbSet<vw__ContractsInfo__SystemUsers_Contracts_Allowances> vw__ContractsInfo__SystemUsers_Contracts_Allowances { get; set; }
        public virtual DbSet<vw__PaymentInfo__BookingRs_BookingRooms_Customers> vw__PaymentInfo__BookingRs_BookingRooms_Customers { get; set; }
        public virtual DbSet<vw__PermitInfo__SystemUsers_Permits_PermitDetails> vw__PermitInfo__SystemUsers_Permits_PermitDetails { get; set; }
        public virtual DbSet<vw__SearchCustomer__Companies_CustomerGroups_Customers> vw__SearchCustomer__Companies_CustomerGroups_Customers { get; set; }
        public virtual DbSet<vw__ServicesInfo__Services_ServiceGroups> vw__ServicesInfo__Services_ServiceGroups { get; set; }
        public virtual DbSet<vw__SystemUsersInfo__SystemUsers_Divisions> vw__SystemUsersInfo__SystemUsers_Divisions { get; set; }
        public virtual DbSet<vw_QueryDataPayment_Ext> vw_QueryDataPayment_Ext { get; set; }
        public virtual DbSet<vw_Support1_DataPayment> vw_Support1_DataPayment { get; set; }
        public virtual DbSet<vw_Support2_DataPayment> vw_Support2_DataPayment { get; set; }
    
        [DbFunction("DatabaseDA", "f_split")]
        ...
        [DbFunction("DatabaseDA", "Get_Status_Room_In_Date")]
        ...
        public virtual int sp_AutoChangeStatusBookingR(Nullable<int> iDBookingR, Nullable<int> iDBookingH)
        {
            var iDBookingRParameter = iDBookingR.HasValue ?
                new ObjectParameter("IDBookingR", iDBookingR) :
                new ObjectParameter("IDBookingR", typeof(int));
    
            var iDBookingHParameter = iDBookingH.HasValue ?
                new ObjectParameter("IDBookingH", iDBookingH) :
                new ObjectParameter("IDBookingH", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_AutoChangeStatusBookingR", iDBookingRParameter, iDBookingHParameter);
        }
        ...
        public virtual int sp_PaymentExt_GetAllData()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_PaymentExt_GetAllData");
        }
    
        public virtual int sp_PaymentExt_GetAllData_1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_PaymentExt_GetAllData_1");
        }
    
        public virtual ObjectResult<sp_PaymentExt_GetAllData_Ext_Result> sp_PaymentExt_GetAllData_Ext()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_PaymentExt_GetAllData_Ext_Result>("sp_PaymentExt_GetAllData_Ext");
        }
    
        public virtual ObjectResult<sp_Room_CountAvailableRooms_ByType_ByTime_ByLang_Result> sp_Room_CountAvailableRooms_ByType_ByTime_ByLang(Nullable<System.DateTime> start, Nullable<System.DateTime> end, Nullable<int> iDLang)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Room_CountAvailableRooms_ByType_ByTime_ByLang_Result>("sp_Room_CountAvailableRooms_ByType_ByTime_ByLang", startParameter, endParameter, iDLangParameter);
        }
        ...
        public virtual int sp_Save_BookingHalls(Nullable<int> iD, string codeHall, Nullable<decimal> cost, Nullable<double> percentTax, Nullable<decimal> costRef_Halls, Nullable<System.DateTime> date, Nullable<System.DateTime> lunarDate, Nullable<int> bookingStatus, Nullable<int> unit, Nullable<int> tableOrPerson, string note, Nullable<int> status, string location, Nullable<System.TimeSpan> startTime, Nullable<System.TimeSpan> endTime, Nullable<bool> isAllDayEvent, Nullable<bool> color, Nullable<bool> isRecurring, Nullable<bool> isEditable, string additionalColumn1, Nullable<int> iDBookingH, Nullable<int> indexSubPayment, Nullable<System.DateTime> invoiceDate, string invoiceNumber, Nullable<System.DateTime> acceptDate)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            var codeHallParameter = codeHall != null ?
                new ObjectParameter("CodeHall", codeHall) :
                new ObjectParameter("CodeHall", typeof(string));
            ...
            var costRef_HallsParameter = costRef_Halls.HasValue ?
                new ObjectParameter("CostRef_Halls", costRef_Halls) :
                new ObjectParameter("CostRef_Halls", typeof(decimal));
    
            var dateParameter = date.HasValue ?
                new ObjectParameter("Date", date) :
                new ObjectParameter("Date", typeof(System.DateTime));
    
            var lunarDateParameter = lunarDate.HasValue ?
                new ObjectParameter("LunarDate", lunarDate) :
                new ObjectParameter("LunarDate", typeof(System.DateTime));
            ...
            var tableOrPersonParameter = tableOrPerson.HasValue ?
                new ObjectParameter("TableOrPerson", tableOrPerson) :
                new ObjectParameter("TableOrPerson", typeof(int));
            ...
            var isAllDayEventParameter = isAllDayEvent.HasValue ?
                new ObjectParameter("IsAllDayEvent", isAllDayEvent) :
                new ObjectParameter("IsAllDayEvent", typeof(bool));
    
            var colorParameter = color.HasValue ?
                new ObjectParameter("Color", color) :
                new ObjectParameter("Color", typeof(bool));
    
            var isRecurringParameter = isRecurring.HasValue ?
                new ObjectParameter("IsRecurring", isRecurring) :
                new ObjectParameter("IsRecurring", typeof(bool));
            ...
            var additionalColumn1Parameter = additionalColumn1 != null ?
                new ObjectParameter("AdditionalColumn1", additionalColumn1) :
                new ObjectParameter("AdditionalColumn1", typeof(string));
        ...
        public virtual int sp_Save_BookingHalls_Service(Nullable<int> iD, string info, Nullable<int> type, Nullable<int> status, Nullable<bool> disable, Nullable<int> iDBookingHall, Nullable<int> iDService, Nullable<decimal> cost, Nullable<System.DateTime> date, Nullable<double> percentTax, Nullable<decimal> costRef_Services, Nullable<double> quantity, Nullable<int> indexSubPayment, Nullable<System.DateTime> acceptDate, string invoiceNumber, Nullable<System.DateTime> invoiceDate)
        {
            ...
            var iDBookingHallParameter = iDBookingHall.HasValue ?
                new ObjectParameter("IDBookingHall", iDBookingHall) :
                new ObjectParameter("IDBookingHall", typeof(int));
        ...
        public virtual int sp_Save_BookingRooms(Nullable<int> iD, Nullable<int> iDBookingR, string codeRoom, Nullable<decimal> cost, Nullable<double> percentTax, Nullable<decimal> costRef_Rooms, string note, Nullable<System.DateTime> checkInPlan, Nullable<System.DateTime> checkInActual, Nullable<System.DateTime> checkOutPlan, Nullable<System.DateTime> checkOutActual, Nullable<int> bookingStatus, Nullable<int> status, Nullable<System.DateTime> startTime, Nullable<System.DateTime> endTime, Nullable<bool> isAllDayEvent, Nullable<bool> color, Nullable<bool> isRecurring, Nullable<bool> isEditable, string additionalColumn1, Nullable<double> costPendingRoom, Nullable<decimal> timeInUser, Nullable<int> type, Nullable<bool> disable, Nullable<int> indexSubPayment, string priceType, Nullable<decimal> addTimeStart, Nullable<decimal> addTimeEnd, Nullable<System.DateTime> acceptDate, string invoiceNumber, Nullable<System.DateTime> invoiceDate)
        {
            ...
            var costRef_RoomsParameter = costRef_Rooms.HasValue ?
                new ObjectParameter("CostRef_Rooms", costRef_Rooms) :
                new ObjectParameter("CostRef_Rooms", typeof(decimal));
    
            var noteParameter = note != null ?
                new ObjectParameter("Note", note) :
                new ObjectParameter("Note", typeof(string));
    
            var checkInPlanParameter = checkInPlan.HasValue ?
                new ObjectParameter("CheckInPlan", checkInPlan) :
                new ObjectParameter("CheckInPlan", typeof(System.DateTime));
    
            var checkInActualParameter = checkInActual.HasValue ?
                new ObjectParameter("CheckInActual", checkInActual) :
                new ObjectParameter("CheckInActual", typeof(System.DateTime));
    
            var checkOutPlanParameter = checkOutPlan.HasValue ?
                new ObjectParameter("CheckOutPlan", checkOutPlan) :
                new ObjectParameter("CheckOutPlan", typeof(System.DateTime));
    
            var checkOutActualParameter = checkOutActual.HasValue ?
                new ObjectParameter("CheckOutActual", checkOutActual) :
                new ObjectParameter("CheckOutActual", typeof(System.DateTime));
            ...
            var costPendingRoomParameter = costPendingRoom.HasValue ?
                new ObjectParameter("CostPendingRoom", costPendingRoom) :
                new ObjectParameter("CostPendingRoom", typeof(double));
    
            var timeInUserParameter = timeInUser.HasValue ?
                new ObjectParameter("TimeInUser", timeInUser) :
                new ObjectParameter("TimeInUser", typeof(decimal));
            ...
            var addTimeStartParameter = addTimeStart.HasValue ?
                new ObjectParameter("AddTimeStart", addTimeStart) :
                new ObjectParameter("AddTimeStart", typeof(decimal));
    
            var addTimeEndParameter = addTimeEnd.HasValue ?
                new ObjectParameter("AddTimeEnd", addTimeEnd) :
                new ObjectParameter("AddTimeEnd", typeof(decimal));
