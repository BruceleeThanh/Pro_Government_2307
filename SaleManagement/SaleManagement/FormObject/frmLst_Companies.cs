...
namespace SaleManager
{
    public partial class frmLst_Companies : DevExpress.XtraEditors.XtraForm
    {
        ...
        // Thanh them chuc nang In danh sach cong ty
        private void btnPrinting_Click (object sender, EventArgs e) {
            frmRpt_ListCompanies afrmRpt_ListCompanies = new frmRpt_ListCompanies(aListCompanies);
            ReportPrintTool tool = new ReportPrintTool(afrmRpt_ListCompanies);
            tool.ShowPreview();
        }
    }
}
